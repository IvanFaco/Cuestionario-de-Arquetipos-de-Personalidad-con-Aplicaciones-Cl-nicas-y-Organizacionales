...
export function getObjectiveLabel(objective: ObjectiveKey): string {
  switch (objective) {
    case "clarity_patterns":
      return "Entender con mas claridad mis patrones de personalidad";
    case "emotional_blocks":
      return "Identificar bloqueos emocionales o internos";
    case "relationships":
      return "Comprender mejor como me vinculo con otras personas";
    case "purpose_direction":
      return "Ganar claridad sobre mi proposito o direccion vital";
    case "stress_decisions":
      return "Entender como reacciono bajo estres y al tomar decisiones";
    case "self_esteem_identity":
      return "Fortalecer mi autoestima y mi sentido de identidad";
    case "shadow_integration":
      return "Reconocer aspectos de mi sombra e integrarlos mejor";
    case "life_transition":
      return "Orientarme mejor en un momento de cambio o transicion";
    default:
      return "Entender con mas claridad mis patrones de personalidad";
  }
}
...
export function buildDemoProfile(input: DemoInput): DemoProfile {
  return {
    ...
    objetivo_label: getObjectiveLabel(input.objetivo)
  };
}
